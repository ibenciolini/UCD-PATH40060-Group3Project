...
Cross-reference the cluster-marker shortlist with CRISPR essentiality scores from DepMap, restricted to brain/CNS cell lines. A gene that is both upregulated in a cluster AND broadly essential in brain lines is a strong candidate for therapeutic inhibition. Link to download the file data: CRISPRGeneEffect.csv[https://depmap.org/portal/download/api/download?file_name=downloads-by-canonical-id%2F26q1-public-3b44.1%2FCRISPRGeneEffect.csv&dl_name=CRISPRGeneEffect.csv&bucket=depmap-external-downloads]
